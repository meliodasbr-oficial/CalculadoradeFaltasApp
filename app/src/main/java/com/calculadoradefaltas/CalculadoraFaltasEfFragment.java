...
public class CalculadoraFaltasEfFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_calculadora_faltas_ef, container, false);

        spinners = new Spinner[]{
                view.findViewById(R.id.spinner_artes),
                view.findViewById(R.id.spinner_ciencias),
                view.findViewById(R.id.spinner_educacao_fisica),
                view.findViewById(R.id.spinner_religioso),
        ...
        // Preencher os spinners com a carga horária
